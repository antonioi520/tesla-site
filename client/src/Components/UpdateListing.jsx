...
class UpdateListing extends Component {
    ...
    onSubmit(e) {
        ...
        axios.put(`/listing/UpdateListing/${currentListing}`, formData, {
        }).then(res => {
    ...
    retrieveListings() {
        ...
        getListing(`${currentListing}`)
            ...
            this.setState({
                ...
                vin: this.state.userListing.vin,
                listing_type: this.state.userListing.listing_type,
                battery: this.state.userListing.battery,
                city: this.state.userListing.city,
                state: this.state.userListing.state,
                mileage: this.state.userListing.mileage,
                asking_price: this.state.userListing.asking_price,
                car_condition: this.state.userListing.car_condition,
                autopilot: this.state.userListing.autopilot,
                warranty: this.state.userListing.warranty,
                self_driving: this.state.userListing.self_driving,
                modifications: this.state.userListing.modifications,
                made_repairs: this.state.userListing.made_repairs,
                own_title: this.state.userListing.own_title,
                thumbnail: this.state.userListing.thumbnail,
                // sticker: this.state.,
                // pictures: this.state.
            });
        })
